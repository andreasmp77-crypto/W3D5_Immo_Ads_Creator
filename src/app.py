...
def validate_address_payload(
    ...
    *,
    ...
    Returns:
        (errors, warnings) where errors should block generation and warnings can
        be shown to the user without stopping the workflow.
    """
    ...
    if verify_external_address and not errors:
        verification = verify_address_with_geopy(street_name, house_number, postal_code, city)
